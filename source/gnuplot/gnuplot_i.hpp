...
#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
 #define GNUPLOTFILENAME "pgnuplot.exe"
 #define GNUPLOTPATH "C:/program files/gnuplot/bin/"
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
 #define GNUPLOTFILENAME "gnuplot"
 #define GNUPLOTPATH "/usr/local/bin/"
#endif

#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
 #define TERMINAL_STD "windows"
#elif ( defined(unix) || defined(__unix) || defined(__unix__) ) && !defined(__APPLE__)
 #define TERMINAL_STD "x11"
#elif defined(__APPLE__)
 #define TERMINAL_STD "aqua"
#endif
